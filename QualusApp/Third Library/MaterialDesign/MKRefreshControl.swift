...
open class MKRefreshControl: UIControl {
    ...
    fileprivate func animationSecondPhase() {
        ...
        startHeadAnim.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseIn)
        ...
        startTailAnim.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseIn)
        ...
        endHeadAnim.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseIn)
        ...
        endTailAnim.toValue = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseIn)
